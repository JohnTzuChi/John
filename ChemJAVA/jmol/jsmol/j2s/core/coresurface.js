...
case 2109448:
thisSet = eval.expandFloatArray (eval.floatParameterSet (++i, 1, 2147483647), 1);
i = eval.iToken;
break;
case 36867:
thisSet =  Clazz_newIntArray (-1, [this.intParameter (++i)]);
break;
case 12289:
propertyName = "center";
propertyValue = this.centerParameter (++i);
...
J.shape.Shape.appendCmd (sb, id + J.shapesurface.Isosurface.subsetString (imesh.jvxlData.thisSet));
...
Clazz_load (null, "J.jvxl.data.JvxlCoder", ["java.lang.Float", "JU.BS", "$.Lst", "$.P3", "$.PT", "$.SB", "J.api.Interface", "J.jvxl.data.VolumeData", "J.shapesurface.Isosurface", "JU.BSUtil", "$.C", "$.Escape", "$.Logger", "JV.Viewer"], function () {
...
var s = J.shapesurface.Isosurface.subsetString (jvxlData.thisSet);
if (s.startsWith (" subset ")) J.jvxl.data.JvxlCoder.addAttrib (attribs, "\n  subset", s.substring (8));
