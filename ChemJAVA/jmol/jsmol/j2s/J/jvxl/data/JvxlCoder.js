...
Clazz.load (null, "J.jvxl.data.JvxlCoder", ["java.lang.Float", "JU.BS", "$.Lst", "$.P3", "$.PT", "$.SB", "J.api.Interface", "J.jvxl.data.VolumeData", "J.shapesurface.Isosurface", "JU.BSUtil", "$.C", "$.Escape", "$.Logger", "JV.Viewer"], function () {
